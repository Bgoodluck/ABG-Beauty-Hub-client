...
//       `${summaryApi.staffDetails.url}/${params?.id}`,
//       {
...
//         const response = await fetch(
//           summaryApi.staffReviewUpdate.url.replace(
//             ":reviewId",
//             editingReview._id
//           ),
//           {
...
//             {zoomOpen && (
//               <div
//                 className={`hidden lg:block absolute min-w-[400px] min-h-[400px] overflow-hidden bg-slate-300 p-1 -right-[510px] top-0 ${
...
//                 Price: {displayNGNCurrency(dataDetails?.staffPrice)}
//               </p> */}
//               {/* <p className='text-red-500 line-through text-sm'>
//                 Discount: {displayNGNCurrency(dataDetails?.staffDiscount)}
//               </p> */}
//             </div>
...
//         <CategoryStaffDisplay
//           staffCategory={dataDetails?.staffCategory}
//           heading={"Alternative Stylists"}
//         />
//       )}
...
//               <div className="flex">{renderStarRating(rating, setRating)}</div>
//             </div>
//             <textarea
//               value={review}
