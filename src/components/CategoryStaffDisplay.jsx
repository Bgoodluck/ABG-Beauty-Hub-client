...
function CategoryStaffDisplay({ staffCategory, heading }) {
    ...
    // const handleAddToCart = async(e, staffId) => {
    //    await addToCart(e, staffId, fetchUserAddToCart);
    // }
                            ...
                            data.map((staff, index) => (
                                ...
                                >
                                    ...
                                    <div className='p-4 grid gap-3'>
                                        ...
                                        <button 
                                            // onClick={(e) => handleAddToCart(e, staff?._id)}
...
export default CategoryStaffDisplay;